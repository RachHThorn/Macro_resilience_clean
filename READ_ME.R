# R Thornley
# Instructions for code for the manuscript:
# 'Community complexity modulates the predictive power of demographic metrics on plant species resilience to disturbances in a distributed grassland experiment'
# January 2026
...
# NOTE:
# the mixedup package is not available for latest versions of R on CRAN so needs 
...
################################################################################
# Data Processing and Analysis Scripts main paper # (subfolder name: S_scripts)
################################################################################

# script 1: 
source("code/S_scripts/S1_get_master_data_DRAGNet_COMPADRE_overlap.R")
# NOTE: this script does not run from the open source data set provided with this paper
# This is because the full network data set is under partial embargo due to network authorship
# and data sharing rules. Only the data used in the main body of this publication
# can be shared publicly at this stage
# this data is one of the outputs of this script

# script 2: Get_master_data_DRAGNet_modelling
source("code/S_scripts/S2_process_DRAGNet_data_for_modelling.R")
...
# Only panels B and C are prodcued inside R
...
################################################################################
# Supplementary Information / supporting information figures and tables / Data archiving # (folder: A_scripts)
################################################################################
...
# Data_submission_prep.r
# preparation of data for archiving
